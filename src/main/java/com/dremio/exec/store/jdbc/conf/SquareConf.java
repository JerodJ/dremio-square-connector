...
@SourceType(value = "SquareARP", label = "Square",uiConfig = "square-layout.json")
public class SquareConf extends AbstractArpConf<SquareConf> {
  private static final String ARP_FILENAME = "arp/implementation/square-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.square.SquareDriver";
